...
```{r cars}
data_by_weeks <- read_csv("phase4_current_results_p1204.csv", col_types = "ffnnnnnnnnnnncc")
...
plot(c(0.01, 0.2, 0.4, 0.6, 0.8, 0.99), kumaraswa_den(c(0.01, 0.2, 0.4, 0.6, 0.8, 0.99), best_params$p1, best_params$p2)/sum(kumaraswa_den(c(0.01, 0.2, 0.4, 0.6, 0.8, 0.99), best_params$p1, best_params$p2)), ylim = c(0, 0.3))
