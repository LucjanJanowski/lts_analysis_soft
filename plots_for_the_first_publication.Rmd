...
for (user in unique(plot_data$user_short)) {
  ...
  fited_vmaf %>% 
    ...
    labs(title = "Logistic model of scores versus VMAF", x = "VMAF", y = "Modelled score", color = "User ID") + theme_bw() + scale_linetype_manual(values = c("dashed", "solid"), guide = "none") + scale_x_reverse()
